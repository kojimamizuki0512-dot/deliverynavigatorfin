...
import { api } from "./api"; // ← getToken/clearToken は不要
...
export default function App() {
  ...
  async function fetchAll() {
    setMsg("");
    try {
      const r = await api.dailyRoute();         // デモ用ルート
      setRoute(Array.isArray(r) ? r : (r?.route || []));
      // ここで必要に応じて setMonthTotal(await api.monthlyTotal()) などに差し替え
